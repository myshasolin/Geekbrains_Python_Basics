...
num_5 = ComplexNumber(3, 'i')
num_6 = ComplexNumber(-2, '2i')
result_of_addition_1 = num_1 + num_2
print(result_of_addition_1)
result_of_addition_2 = num_3 + num_4
print(result_of_addition_2)
print('результат умножения')
result_of_multiplication_1 = num_1 * num_2
print(result_of_multiplication_1)
result_of_multiplication_2 = num_3 * num_4
print(result_of_multiplication_2)
result_of_multiplication_2 = num_5 * num_6
print(result_of_multiplication_2)
